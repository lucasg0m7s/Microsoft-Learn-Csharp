...
while (transactions > 0)
{
    ...
    try
    {
        ...
        MakeChange(itemCost, ref cashTill, paymentTwenties, paymentTens, paymentFives, paymentOnes);
...
static void MakeChange(int cost, ref int[] cashTill, int twenties, int tens = 0, int fives = 0, int ones = 0)
{
    int[] cashTillCopy = (int[])cashTill.Clone();
